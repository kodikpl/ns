// === Shimeji Plugin v1.0 ===
// Drop this into your site or import via a <script> tag.
// Requires: shimeji.js + randomWalk.js + shimeji.css to be loaded first.

(function() {
  const SHIMEJI_BASE =
    "https://example.space/shimejiee%20-%20Tama%20Mod/img/Shimeji/";
  const CONFIG = {
    name: "Squalo",
    license: "unknown",
    ...
    actions: {
      sleep: [
        { src: "shime21.png", anchor: [64,128], move: {x:0,y:0}, duration:2500 }
      ],
      stand: [
        { src: "shime1.png", anchor: [64,128], move: {x:0,y:0}, duration:250 }
      ],
      walk: [
      ...
      jump: [
        { src:"shime22.png",anchor:[64,128],move:{x:0,y:0},duration:200 }
      ],
      fall: [
        { src:"shime4.png",anchor:[64,128],move:{x:0,y:40},duration:100 }
      ],
      land: [
